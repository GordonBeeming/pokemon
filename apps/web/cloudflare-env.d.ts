/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null ./cloudflare-env.d.ts` (hash: 1767f6bb95874bd1d1423d16616fbf44)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	ART: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	OWNER_LABEL: "Gordon Beeming";
	PUBLIC_ORIGIN: "https://pokedex.gordonbeeming.com";
	AUTH_COORDINATOR: DurableObjectNamespace<import("./src/worker/index").AuthCoordinator>;
	CATALOGUE_FETCHER: DurableObjectNamespace<import("./src/worker/index").CatalogueFetcher>;
	CATALOGUE_SYNC: Workflow<Parameters<import("./src/worker/index").CatalogueSyncWorkflow['run']>[0]['payload']>;
	PRICE_SYNC: Workflow<Parameters<import("./src/worker/index").PriceSyncWorkflow['run']>[0]['payload']>;
	FX_SYNC: Workflow<Parameters<import("./src/worker/index").FxSyncWorkflow['run']>[0]['payload']>;
	BACKUP: Workflow<Parameters<import("./src/worker/index").BackupWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "AuthCoordinator" | "CatalogueFetcher";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OWNER_LABEL" | "PUBLIC_ORIGIN">> {}
}
